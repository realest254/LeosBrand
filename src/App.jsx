  ...
  return (
    <HelmetProvider> {/* Wrap your app with HelmetProvider */}
      <Router basename="/LeosBrand">
        <div className="App">
          <Helmet>
            <title>Leo's Wear- Your Go-To Online Clothing Store</title>
            ...
            <meta name="author" content="Leo's Wear" />
            <meta property="og:title" content="Leo's Wear- Your Go-To Online Clothing Store" />
            ...
            <meta property="og:site_name" content="Leo's Wear" />
